...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/quetz-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10257&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/quetz-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `quetz` can be installed with:

```
conda install quetz
```

It is possible to list all of the versions of `quetz` available on your platform with:
